...
const side_data = [
    {"name":"front", "description":"Show the photo page of your photo id (ex: Passport) to the camera"},
  ...
  export default ({setTabStatus, documentDetails, setDocumentDetails }) => {
    ...
    const captureTextDetails = async (image) => {
        ...
        if(detectEntitiesResponse.$response.error) {
            ...
            let filteredEntities = _.filter(sortedEntities,(entity) => entity.Score > 0.7)
